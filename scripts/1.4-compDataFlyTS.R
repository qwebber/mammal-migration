...
## re-run for only Insectivores/frugivores

TSflyDiet <- TSfly[diet == "Insectivore" | diet == "Frugivore"]
...
saveRDS(RET, "output/compTSFlyDataDiet.RDS")
...
TSfly[, .N, by = .(habitat_sub, mig)]

TSflyHab <- TSfly[habitat_sub != "BF" & habitat_sub != "TES"]
